...
ATTR_IS_COLLECTION_DATE_MORNING = "is_collection_date_morning"
ATTR_IS_COLLECTION_DATE_AFTERNOON = "is_collection_date_afternoon"
ATTR_IS_COLLECTION_DATE_EVENING = "is_collection_date_evening"
